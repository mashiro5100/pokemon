...
res = requests.get('https://wiki.52poke.com/zh-hans/%E5%B1%9E%E6%80%A7%E7%9B%B8%E5%85%8B%E8%A1%A8')
# print(res.text)

bs = BeautifulSoup(res.text, 'lxml')
tb = bs.find('table', style='border: 2px solid #111; background:#808080; margin-right: 5px; margin-bottom: 5px;')
